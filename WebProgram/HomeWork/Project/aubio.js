var Aubio = function(Aubio) {
	...
	c.buffer ? buffer = c.buffer : ("object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? (c.wasmMemory = new WebAssembly.Memory({
			initial: E / 65536,
			maximum: E / 65536
			...
			function d(a) {
					...
					function g(a) {
							b().then(function(a) {
									...
									x("failed to asynchronously prepare wasm: " +
											a);
									y(a)
							})
					}
					if ("object" !== typeof WebAssembly) return x("no native wasm support detected"), !1;
					...
					c.wasmBinary || "function" !== typeof WebAssembly.instantiateStreaming ||
							Ka(f) || "function" !== typeof fetch ? g(e) : WebAssembly.instantiateStreaming(fetch(f, {
									credentials: "same-origin"
			...
			try {
					...
					J.J || (J.J = [null, [],
							...
							if (0 === b || 10 === b) {
									...
									a: {
											for (var e = b = 0; d[e];) ++e;
											if (16 < e - b && d.subarray && la) b = la.decode(d.subarray(b, e));
											else
													for (e = "";;) {
															var f = d[b++];
															if (!f) {
															...
															if (f & 128) {
																	...
																	if (192 == (f & 224)) e += String.fromCharCode((f & 31) << 6 | k);
																			...
																			if (224 == (f & 240)) f = (f & 15) << 12 | k << 6 | l;
																					...
																					var h = d[b++] & 63;
																					if (240 == (f & 248)) f = (f & 7) << 18 | k << 12 | l << 6 | h;
																					else {
																							var bb = d[b++] & 63;
																							if (248 ==
																									(f & 252)) f = (f & 3) << 24 | k << 18 | l << 12 | h << 6 | bb;
																							else {
																									var m = d[b++] & 63;
					...
					for (b = 0; b < f; b++) {
							for (var l = A[e + 8 * b >> 2], h = A[e + (8 * b + 4) >> 2], k = 0; k < h; k++) J.P(d, z[l + k]);
							a += h
					}
					return a
			} catch (m) {
	...
	function hb(a, b, d) {
			for (; b !== d;) b.w || P("Expected null or instance of " + d.name + ", got an instance of " + b.name), a = b.w(a), b = b.i;
			return a
	}
	function ib(a, b) {
	...
	function jb(a, b) {
			...
			if (this.D) switch (void 0 === b.a.g && P("Passing raw pointer to smart pointer is illegal"), this.ba) {
					case 0:
							b.a.h ===
									this ? d = b.a.g : P("Cannot convert argument of type " + (b.a.h ? b.a.h.name : b.a.f.name) + " to parameter type " + this.name);
							break;
					case 1:
							d = b.a.g;
							break;
	...
	var pb = {};
	function qb(a, b) {
			for (void 0 === b && P("ptr should not be undefined"); a.i;) b = a.w(b), a = a.i;
			return pb[b]
	}
	function rb(a, b) {
	...
	for (var Gb = {}, Hb = Array(256), Ib = 0; 256 > Ib; ++Ib) Hb[Ib] = String.fromCharCode(Ib);
	Ra = Hb;
	...
	c.O = {
			...
			__embind_register_class: function(a, b, d, e, f, l,
					h, k, m, p, g, q, D) {
					g = K(g);
					l = V(f, l);
					k && (k = V(h, k));
					...
					Ya([a, b, d], e ? [e] : [], function(b) {
							...
							b = Ua(t, function() {
									...
									if (void 0 === a) throw new O("Tried to invoke ctor of " + g + " with invalid number of parameters (" +
											arguments.length + ") - expected (" + Object.keys(m.m).toString() + ") parameters instead!");
					...
					Ya([], [a], function(a) {
							...
							Ya([], h, function(e) {
									a.b.m[b - 1] = function() {
											...
											h[0] = l;
											for (var k = 1; k <
													b; ++k) h[k] = e[k].toWireType(a, arguments[k - 1]);
											h = f.apply(null, h);
											zb(a);
					...
					Ya([], [a], function(a) {
							...
							Ya([], m, function(e) {
									...
									var mb = "void" !== e[0].name,
											N = "",
											W = "";
									for (g = 0; g < q - 2; ++g) N += (0 !== g ? ", " : "") + "arg" + g, W += (0 !== g ? ", " : "") + "arg" + g + "Wired";
									...
									if (D) k +=
											...
											for (g = t ? 1 : 2; g < e.length; ++g) q = 1 === g ? "thisWired" : "arg" + (g - 2) + "Wired", null !== e[g].l && (k += q + "_dtor(" + q + "); // " + e[g].name + "\n", N.push(q + "_dtor"), m.push(e[g].l));
			...
			__embind_register_memory_view: function(a,
					b, d) {
					function e(a) {
							a >>= 2;
							var b = B;
			...
			__embind_register_std_string: function(a, b) {
					...
					Q(a, {
							name: b,
							fromWireType: function(a) {
									for (var b = B[a >> 2], d = Array(b), l = 0; l < b; ++l) d[l] = String.fromCharCode(z[a + 4 + l]);
									X(a);
									return d.join("")
							},
							toWireType: function(a, b) {
			...
			__embind_register_std_wstring: function(a,
					b, d) {
					d = K(d);
					if (2 === b) {
							var e = function() {
					...
					Q(a, {
							name: d,
							fromWireType: function(a) {
									for (var b = e(), d = B[a >> 2], l = Array(d), p = a + 4 >> f, g = 0; g < d; ++g) l[g] = String.fromCharCode(b[p + g]);
									X(a);
									return l.join("")
							},
							toWireType: function(a, d) {
									var k = e(),
											...
											l = Kb(4 + h * b);
									B[l >> 2] = h;
									for (var g = l + 4 >> f, q = 0; q < h; ++q) k[g + q] = d.charCodeAt(q);
									null !== a && a.push(X, l);
									return l
							},
							argPackAdvance: 8,
	...
	function Nb() {
			...
			if (!(0 < F)) {
					if (c.preRun)
							for ("function" == typeof c.preRun && (c.preRun = [c.preRun]); c.preRun.length;) Ga();
					Aa(Ba);
